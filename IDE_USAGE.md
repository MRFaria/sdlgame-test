...
*Open the project:*<br>
Run Code::Blocks, and open the project in `sdlgame-test/build/codeblocks`.<br>
Finally, build and run the project.
...
cd sdlgame-test
mkdir ../eclipse-sdlgame-test
cd ../eclipse-sdlgame-test

# Generate an Eclipse project
cmake ../sdlgame-test -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-sdlgame-test`.<br>
